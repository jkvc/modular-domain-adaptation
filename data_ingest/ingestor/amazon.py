...
class AmazonReviewIngestor(Ingestor):
    def run(self) -> DataCollection:
        ...
        train_collection.class_strs = RATING_NAMES
        train_collection.domain_strs = CATEGORIES
        ...
        test_collection.class_strs = RATING_NAMES
        test_collection.domain_strs = CATEGORIES
